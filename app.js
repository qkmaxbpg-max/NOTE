...
var ACCT_ICONS={
  ...
  // ── E-Wallets (silhouette logos) ──
  'LINE Pay':{bg:'#06C755',svg:'<rect x="7" y="10" width="18" height="13" rx="6" fill="#fff"/><path d="M11 15h3v1.5h-2v1h2V19h-3v-4zM15 15h1.5v4H15v-4zM17.5 15h1.5l1.5 2.5V15h1.5v4h-1.5L19 16.5V19h-1.5v-4z" fill="#06C755"/>'},
  'Apple Pay':{bg:'#000',svg:'<path d="M19.8 10.5c-.5-1.2-1.5-2-2.8-2-.7 0-1.4.3-2 .6-.4.2-.7.4-1 .4s-.6-.2-1-.4c-.5-.3-1.1-.6-1.8-.6-1.5 0-3 1.2-3 3.6 0 2.7 2 6.4 3.5 6.4.5 0 .9-.3 1.3-.5.4-.2.8-.5 1.2-.5s.8.3 1.2.5c.4.2.8.5 1.3.5 1.2 0 2.5-2.4 3.1-4.2a3 3 0 01-2-2.8c0-1 .5-1.8 1-2.5zM16 8.5c.6-.7 1.5-1.2 2.2-1.3 0 .9-.3 1.7-.9 2.3-.6.6-1.3 1-2.1 1-.1-.8.3-1.6.8-2.3z" fill="#fff"/>'},
  '街口':    {bg:'#00C853',svg:'<rect x="7" y="7" width="18" height="18" rx="4" fill="#fff" opacity=".2"/><path d="M10 10h5v12h-5zM17 10h5v5h-5zM17 17h5v5h-5z" fill="#fff" opacity=".9"/><path d="M10 16h5" stroke="#00C853" stroke-width="1.5"/>'},
  '街口支付': {bg:'#00C853',svg:'<rect x="7" y="7" width="18" height="18" rx="4" fill="#fff" opacity=".2"/><path d="M10 10h5v12h-5zM17 10h5v5h-5zM17 17h5v5h-5z" fill="#fff" opacity=".9"/><path d="M10 16h5" stroke="#00C853" stroke-width="1.5"/>'},
  '微信':    {bg:'#07C160',svg:'<ellipse cx="13" cy="16" rx="6" ry="5" fill="#fff"/><ellipse cx="20" cy="13" rx="5" ry="4" fill="#fff" opacity=".75"/><circle cx="11" cy="15.5" r="1" fill="#07C160"/><circle cx="15" cy="15.5" r="1" fill="#07C160"/>'},
  '微信錢包': {bg:'#07C160',svg:'<ellipse cx="13" cy="16" rx="6" ry="5" fill="#fff"/><ellipse cx="20" cy="13" rx="5" ry="4" fill="#fff" opacity=".75"/><circle cx="11" cy="15.5" r="1" fill="#07C160"/><circle cx="15" cy="15.5" r="1" fill="#07C160"/>'},
  '支付寶':  {bg:'#1677FF',svg:'<circle cx="16" cy="16" r="10" fill="#fff" opacity=".15"/><path d="M10 14c3 0 4 2 6 2s3-2 6-2" stroke="#fff" stroke-width="2.5" fill="none" stroke-linecap="round"/><path d="M10 10h12" stroke="#fff" stroke-width="2.5" stroke-linecap="round"/><path d="M16 10v4" stroke="#fff" stroke-width="2.5" stroke-linecap="round"/><path d="M12 19c2 2 6 3 10 1" stroke="#fff" stroke-width="2" fill="none" stroke-linecap="round"/>'},
  'Paypal':  {bg:'#003087',svg:'<path d="M12 7h5c3 0 5 1.5 4.5 4.5S18 16 15 16h-2l-1 5H9l3-14z" fill="#fff" opacity=".9"/><path d="M14 9h4c2 0 3 1 2.5 3s-2.5 3-4.5 3h-2" fill="none" stroke="#003087" stroke-width="1"/>'},
  'PayPal':  {bg:'#003087',svg:'<path d="M12 7h5c3 0 5 1.5 4.5 4.5S18 16 15 16h-2l-1 5H9l3-14z" fill="#fff" opacity=".9"/><path d="M14 9h4c2 0 3 1 2.5 3s-2.5 3-4.5 3h-2" fill="none" stroke="#003087" stroke-width="1"/>'},
  '眾安':    {bg:'#E8383D',svg:'<path d="M8 22V10l8-4 8 4v12" stroke="#fff" stroke-width="2.5" fill="none" stroke-linejoin="round"/><circle cx="16" cy="16" r="3" fill="#fff"/><path d="M16 19v4" stroke="#fff" stroke-width="2"/>'},
  '眾安銀行': {bg:'#E8383D',svg:'<path d="M8 22V10l8-4 8 4v12" stroke="#fff" stroke-width="2.5" fill="none" stroke-linejoin="round"/><circle cx="16" cy="16" r="3" fill="#fff"/><path d="M16 19v4" stroke="#fff" stroke-width="2"/>'},
  '悠遊付':  {bg:'#00AEEF',svg:'<circle cx="16" cy="15" r="8" fill="none" stroke="#fff" stroke-width="2.5"/><path d="M12 15a4 4 0 018 0" stroke="#fff" stroke-width="2" fill="none" stroke-linecap="round"/><circle cx="16" cy="15" r="2" fill="#fff"/><path d="M13 24h6" stroke="#fff" stroke-width="2" stroke-linecap="round"/>'},
  'icash':   {bg:'#FF6B00',svg:'<circle cx="16" cy="14" r="8" fill="none" stroke="#fff" stroke-width="2.5"/><path d="M16 10v8M13 14h6" stroke="#fff" stroke-width="2" stroke-linecap="round"/><path d="M12 24h8" stroke="#fff" stroke-width="2" stroke-linecap="round"/>'},
  'Samsung Pay':{bg:'#1428A0',svg:'<path d="M9 13c0-3 3-5 7-5s7 2 7 5" stroke="#fff" stroke-width="2.5" fill="none" stroke-linecap="round"/><path d="M9 19c0 3 3 5 7 5s7-2 7-5" stroke="#fff" stroke-width="2.5" fill="none" stroke-linecap="round"/><path d="M9 13c2 2 5 3 7 3s5-1 7-3" stroke="#fff" stroke-width="1.5" fill="none"/><path d="M9 19c2-2 5-3 7-3s5 1 7 3" stroke="#fff" stroke-width="1.5" fill="none"/>'},
  'Google Pay':{bg:'#4285F4',svg:'<path d="M8 16c0-4.4 3.6-8 8-8 2.1 0 4 .8 5.4 2.1L19 12.5c-.8-.8-1.8-1.2-3-1.2-2.8 0-5 2.2-5 5s2.2 5 5 5c2.2 0 3.6-1 4.2-2.5H16v-3h8.5c.1.5.2 1 .2 1.7 0 5-3.4 8.5-8.7 8.5-4.4 0-8-3.6-8-8z" fill="#fff"/>'},
